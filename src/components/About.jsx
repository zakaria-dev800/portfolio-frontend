...
export default function About() {
    ...
    const tools = [
        { name: 'vscode', icon: '/frontend/dist/assets/vscode.png' },
        { name: 'mongodb', icon: '/frontend/dist/assets/mongodb.png' },
        { name: 'figma', icon: '/frontend/dist/assets/figma.png' },
        { name: 'git', icon: '/frontend/dist/assets/git.png' },
    ];
    ...
    return (
        <section id="about" className="w-full px-[10%] py-20 scroll-mt-20 overflow-hidden">
            <div className="flex w-full flex-col lg:flex-row items-center gap-24 my-20">
                ...
                >
                    <img
                        src={userData ? `/frontend/dist/assets/profil_img.jpeg` : '/frontend/dist/assets/user-image.png'}
                        alt="Profile"
                    ...
                    <div className="bg-white dark:bg-gray-900 w-1/2 aspect-square absolute right-0 bottom-0 rounded-full translate-x-1/4 translate-y-1/3 shadow-xl flex items-center justify-center border dark:border-white/10 z-20">
                        <img src="/frontend/dist/assets/option2.png" alt="" className="w-full animate-spin_slow dark:invert" />
                        <img src="/frontend/dist/assets/dev-icon.png" alt="" className="w-1/4 absolute dark:invert" />
                    </div>
                </motion.div>
